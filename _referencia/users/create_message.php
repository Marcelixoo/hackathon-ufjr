...
if(!empty($_POST['send_message'])){
  ...
  Redirect::to('view_all_users.php?msg=Message+sent!');
}
        ...
        <?php if(!empty($id)){ ?>
          <div class="col-xs-12 col-md-10">
            ...
            <form name="create_message" action="create_message.php?id=<?=$id?>" method="post">
              ...
              <p>
                <input class="btn btn-primary" type="submit" name="send_message" value="Send Message" href="view_all_users.php">
            ...
            <?php }else{ ?>
              <form class="searchUserMessage" name="search" action="create_message.php" method="post">
