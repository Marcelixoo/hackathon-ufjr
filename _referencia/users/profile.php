		 ...
		 <div class="container">
				...
				<div class="well">
					<div class="row">
						...
						<div class="container botoesProfile">
							<div class="row">
								<?php if ($thisUserID != $userID) { ?>
									<a class="btn btn-success" href="create_message.php?id=<?=$userID?>" role="button">Send a message</a>
								<?php } ?>
								<a class="btn btn-success btn-danger" href="account.php" role="button">Back</a>
							</div>
						</div>
