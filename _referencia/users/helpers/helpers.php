...
// Readeable file size --> retorna o tamanho do arquivo de acordo com a unidade mais conveniente
function size($path) {
...
//escapes strings and sets character set --> limpar possíveis códigos HTML por injeção XSS
function sanitize($string) {
	return htmlentities($string, ENT_QUOTES, 'UTF-8');
}


// Pega o nome do arquivo atual que está rodando o script
function currentPage() {
	$uri = $_SERVER['PHP_SELF']; /*Contêm o caminho relativo até o arquivo --> path/arquivo.php*/
	$path = explode('/', $uri); /*Separa o conteúdo da $uri em uma array ['path', 'arquivo.php']*/
	$currentPage = end($path); /*Retorna apenas o último elemento do array $path --> nome do arquivo desejado*/
	return $currentPage;
}

// Mesma ideia da função currentPage() --> retornando agora a pasta atual que será o penúltimo elemento do array
...
/*Função responsável pelos e-mails enviados e recebidos pelo sistema*/
